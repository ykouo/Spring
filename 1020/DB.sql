...
INSERT INTO MEM (MID,MPW,MNAME,CALL,ROLE) VALUES ('Test','11','테스트','010-test-test','TEST');
...
SELECT * FROM (SELECT ROWNUM AS RNUM, A.BID,A.MID,A.TITLE,A.CONTENT,A.WDATE FROM (SELECT * FROM BOARD ORDER BY BID DESC) A) WHERE TITLE LIKE '%a%' AND RNUM BETWEEN 1 AND 10;
